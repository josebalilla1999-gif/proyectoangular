...
export class TrainerComponent {
  trainers: Trainer[] = [
    ...
    },
    {
      name: 'Malva',
      category: 'Alto Mando',
      description: 'Alto Mando de la Liga Pokémon de Kalos, especialista en Pokémon de tipo Fuego, miembro del Team Flare y presentadora de noticias',
      team: []
    },
    {
      name: 'Drácena',
    ...
    },
    {
      name: 'Giovanni',
      category: 'Villano',
      description: 'Líder del Team Rocket, una persona muy ambiciosa y desea controlar el mundo utilizando los Pokémon',
      team: []
    },
    {
      name: 'Magno',
    ...
    },
    {
      name: 'Lysson',
      category: 'Villano',
      description: 'Líder del Team Flare, una organización que quiere crear un nuevo mundo, en el cual solo ellos tendrían el privilegio de vivir',
      team: []
    },
    {
      name: 'Guzmán',
      category: 'Villano',
      description: 'Líder del Team Skull, una pandilla que se dedica a robar Pokémon de sus entrenadores',
      team: []
    },
    {
      name: 'Samina',
